    ...
    return (
        <div className='w-full md:px-24 px-6 py-16 gap-10 flex md:flex-row flex-col items-center'>
            ...
            <div className='md:w-[50%] w-full flex flex-col'>
                <h4 className='text-[#A42A2A] text-[20px]'>Pastor David and Lola Adeosun</h4>
                ...
                <Link href='' className='flex items-center px-4 py-3 bg-[#2E8B57] rounded-md w-fit mt-6 text-[#F5F5F5] hover:bg-[#1E5631] transition duration-150'>
                    <span>About us</span>
                </Link>
            </div>
        </div>
