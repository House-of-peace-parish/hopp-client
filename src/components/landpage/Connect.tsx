        ...
        <div className='w-full flex md:flex-row flex-col'>
            {
                connectLink.map((item, id) => (
                    <div style={{ backgroundColor: id === 0 ? '#5A9BD5' : '#A42A2A' }} className='md:px-24 px-6 py-16 w-full md:w-[50%] md:h-[500px] flex flex-col justify-center items-center text-[#F5F5F5]' key={item.id}>
