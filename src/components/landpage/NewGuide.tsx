    ...
    return (
        <div className='w-full md:px-24 px-6 py-16 gap-10 flex md:flex-row flex-col items-center'>
            <div className='md:w-[50%] w-full flex flex-col'>
                <h4 data-aos="fade-up-left" className='text-[#A42A2A] text-[20px]'>{newGuide.title}</h4>
                <h3 data-aos="fade-up-left" className='text-[40px] font-semibold'>{newGuide.header}</h3>
                <p data-aos="fade-up-left">{newGuide.desc}</p>
