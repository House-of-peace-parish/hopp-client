...
function CoreMin() {
    return (
        <div className='w-full md:px-24 px-6 py-16'>
            ...
            <Link data-aos="zoom-in-up" className='block w-fit mx-auto' href='/ministries'>
                <div className='flex justify-center items-center gap-2 mt-8 cursor-pointer bg-[#2E8B57] w-[200px] h-[50px] rounded-md hover:bg-[#1E5631] transition text-[#F5F5F5]'>
                    <p>See all</p>
                </div>
            </Link>
        </div>
