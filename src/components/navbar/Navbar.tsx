    ...
    return (
        <div className='w-full'>
            <div className='w-full py-12 flex justify-center items-center'>
                <div className='w-fit flex gap-10'>
                    <div className='flex items-center gap-4'>
                        <Image className='w-[100px] h-[100px] object-cover' src={logoMark} alt="Main logo of rccg" />
                        <div className='w-1 h-[100px] border-l-2 border-l-blue-600'></div>
                        <Image className='w-[200px] h-[100px]' src={parishLogoW} alt="Main logo of House of peace parish" />
                    </div>
            ...
            <div className="w-full py-6 md:py-10 px-6 md:px-24 flex justify-between items-center bg-[#3B82F6] relative">
                ...
                <div
                    onClick={handleNav}
                    className="border-2 border-[#F5F5F5] p-2 rounded-md cursor-pointer md:hidden z-30"
                >
                ...
                {/* Navigation Links */}
                <div className={`
      fixed top-0 left-0 h-full bg-[#3B82F6] flex flex-col items-center justify-center gap-6 
      text-[#F5F5F5] font-semibold text-lg transform transition-transform duration-700 ease-in-out
      ${openNav ? 'translate-x-0 w-[70vw] z-20' : '-translate-x-full'}
      md:static md:flex md:flex-row md:h-auto md:w-auto md:translate-x-0 md:gap-8
    `}
                >
                    <Link href="/">Home</Link>
