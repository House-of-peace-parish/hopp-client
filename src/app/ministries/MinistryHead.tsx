...
import bible from '../../assets/ministries/bible.jpg'

function MinistryHead() {
  return (
    <header className='w-full h-screen relative'>
      <div className='w-full h-full'>
        <Image className='h-full w-full object-cover' src={bible} alt='' />
      </div>
      <div className='absolute top-0 left-0 w-full h-full bg-black/40 flex flex-col justify-center items-center text-[#F5F5F5] md:px-24 px-6 text-center'>
        ...
        <h3 data-aos="zoom-in-up" className='text-[1.5rem] sm:text-[2rem] font-semibold'>Where Passion Meets Purpose in Service to God and Humanity.</h3>
      </div>
    </header>
  )
}
